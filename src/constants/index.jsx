export const features = [
  {
    ...
    caption: "Chat with ANANTRIT",
    title: "Work smarter not harder",
    text: "With ANATRIT, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
    button: {
  ...
  },
  {
    ...
    title: "Be at ease, we all are here for you",
    text: "Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Xora helps keeps your information secure and locked up tighter than Fort Knox.",
    button: {
      icon: "/images/docs.svg",
      title: "Chat, Code & Repeat",
    },
  },
];
...
export const details = [
  {
    ...
    title: "Upload code for contribution",
    link: "/contribute", // Link to the contribution page
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Post your review or opinion",
    link: "/posts", // Link to the posts/reviews page
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Enjoy other perks",
    link: "/perks", // Link to the perks page (or any relevant page)
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "24 / 7 Customer support",
    link: "/support", // Link to the support page
  },
];
...
export const plans = [
  ...
  },
  {
    ...
    priceMonthly: 79,
    priceYearly: 13,
    caption: "For Management Purposes",
    features: [
  ...
  {
    id: "2",
    title: "Industry Equipments",
    priceMonthly: 39,
    priceYearly: 19,
    caption: "Exclusively for Manufacturing",
    features: [
