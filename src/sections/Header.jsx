...
const NavLink = ({ title }) => (
  <LinkScroll className="base-bold text-p4 uppercase transition-colors duration-500 cursor-pointer hover:text-p1 lax-ls:my-4 max-lg-lg:h5">
    {title}
  </LinkScroll>
);
...
const Header = () => {
  return (
    <header className="fixed top-0 left-0 z-50 w-ful py-10">
